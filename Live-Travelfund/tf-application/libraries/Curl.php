 ...
 *** THIRD PARTY CODE. CODE STANDARDS NOT APPLIED. ***
...
class Curl {
	...
	public function execute()
	{
        ...
        isset($this->options['10015']) ?
            log_message('error',"CURL :: options :: " . print_r($this->options['10015'],true))
            :log_message('error',"CURL :: options :: No option"  );
        
//      log_message('error',"CURL :: response" . print_r($this->response,true));
        
      log_message('error', "CURL ::  Curl info " . print_r($this->info["url"], true));
