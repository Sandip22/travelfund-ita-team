  ...
  <div class="large-12 columns">
    <div class="panel" style="margin-top: 20px;"> <span class="panel-title radius"></span>
      <div class="row">
        ...
        <div class="large-5 medium-5 columns margintop1">
        ...
        <div class="large-5 medium-5 columns right margintop1">
          ...
          <div id="faq"></div>
          <a href="<?php echo site_url("application/login");?>">
            <h6>Already started an application?<u> Click here</u></h6>
          </a>
        </div>
      ...
      <div class="row" style="margin-top: 10px;">
        <div class="large-11 medium-11 columns small-centered large-centered">
          <div class="row">
            ...
            <div class="large-3 medium-3 columns">
              <input type="text" name='first_name' id='first_name' placeholder="First Name" value='<?php echo set_value('first_name'); ?>' maxlength="50">
              <div id="err_first_name"><?php echo form_error('first_name'); ?></div>
            </div>
            <div class="large-3 medium-3 columns">
              <input type="text" name='last_name' id='last_name' placeholder="Last Name" value='<?php echo set_value('last_name'); ?>' maxlength="50">
          ...
          <div class="row">
            ...
            <div class="large-9 medium-9 columns ">
              <input type='text' name='email' id='email' value='<?php echo set_value('email'); ?>' maxlength="50" />
          ...
          <div class="row">
            ...
            <div class="large-9 medium-9 columns end">
              <input type='text' name='confirm_email' id='confirm_email' value='<?php echo set_value('confirm_email'); ?>' maxlength="50"/>
          ...
          <div class="row">
            ...
            <div class="large-9 medium-9 columns">
              <h6>*Password must have at least one number, one lowercase, one uppercase letter and minimum six characters.</h6>
            </div>
          </div>
          <div class="row">
            <div class="large-3 medium-3 columns">
            ...
            <div class="large-9 medium-9 columns">
              <h6>*Please remember this details to log in at any time to complete your application</h6>
            </div>
          </div>
          <div class="row">
            <div class="large-3 medium-3 columns">
            ...
            <div class="large-9 medium-9 columns end">
              <input type='text' name='mobile_phone' id='mobile_phone' value='<?php echo set_value('mobile_phone'); ?>' maxlength="13" />
              <div id="err_mobile_phone"><?php echo form_error('mobile_phone'); ?></div>
            </div>
            <div class="large-9 medium-9 columns">
              <h6>Have your mobile phone handy as <strong>we'll be sending you a verification code.</strong> You'll also <strong>need your mobile every time you make a payment </strong>from your account. </h6>
            </div>
          </div>
          <div class="row">
            <div class="large-3 medium-3 columns">
          ...
          <div class="row">
            <div class="large-11 small-11 columns"> <span>
              <h5>
                ...
                </span> <span>I have read and accepted the <a onclick="open_window('display_security_privacy');"><u>security & privacy statement</u></a>.  This includes using my personal 
                information to check my identity & carry out a credit check if required.</h5>
              </span> <br>
              <br>
              <span>
              <h5>Please read the <a onclick="open_window('summary_terms_conditions');"><u>summary box, terms and conditions </u></a>and <a onclick="open_window('pre_contract_information');"><u>pre contract information </u></a>before selecting continue.</h5>
              </span>
